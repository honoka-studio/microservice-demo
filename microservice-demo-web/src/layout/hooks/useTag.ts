...
import type { TagsView } from '@/layout/types'
...
export function useTags() {
  ...
  const tagsViews = reactive<Array<TagsView>>([
    {
      icon: RefreshRight,
      text: '重新加载',
      divided: false,
  ...
  return {
    Close, route, router, visible, showTags, instance, multiTags, showModel, tagsViews, buttonTop,
    buttonLeft, translateX, isFixedTag, pureSetting, activeIndex, getTabStyle, isScrolling, iconIsActive,
    linkIsActive, currentSelect, scheduleIsActive, getContextMenuStyle, closeMenu, onMounted, onMouseenter,
    onMouseleave, onContentFullScreen
  }
}
